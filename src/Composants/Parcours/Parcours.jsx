...
function Parcours({ onBack = () => console.log("onBack non défini") }) {
    ...
    if (selectedYear) {
        switch (selectedYear) {
            case 2022: return <Annee2022 onBack={handleBackToParcours} onYearClick={handleYearClick} />;
            case 2023: return <Annee2023 onBack={handleBackToParcours} onYearClick={handleYearClick} />;
            case 2024: return <Annee2024 onBack={handleBackToParcours} onYearClick={handleYearClick} />;
